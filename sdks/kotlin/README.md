...
[![Documentation](https://img.shields.io/badge/docs-latest-brightgreen.svg)](https://docs.keynetra.com/sdks/kotlin)

Official Kotlin Client SDK for the [KeyNetra](https://keynetra.com) authorization platform. 🛡️
...
```bash
implementation("io.keynetra:keynetra-client-kotlin:0.1.1")
```
...
For full API documentation, please visit the [KeyNetra Documentation Portal](https://docs.keynetra.com/sdks/kotlin).

## 🤝 Support

- **Source**: [https://github.com/keynetra/keynetra-client-kotlin](https://github.com/keynetra/keynetra-client-kotlin)
- **Issues**: [GitHub Issues](https://github.com/keynetra/keynetra-client-kotlin/issues)
- **License**: Apache-2.0
