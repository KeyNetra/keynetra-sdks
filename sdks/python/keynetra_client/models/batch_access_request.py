...
class BatchAccessRequest(BaseModel):
    ...
    consistency: Optional[StrictStr] = 'eventual'
    revision: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["user", "items", "consistency", "revision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": obj.get("user"),
            "items": [BatchAccessItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
