...
class SimulationResponse(BaseModel):
    ...
    """ # noqa: E501
    decision: StrictStr
    matched_policies: List[StrictStr]
    reason: Optional[StrictStr] = None
    policy_id: Optional[StrictStr] = None
    explain_trace: Optional[List[Dict[str, Any]]] = None
    failed_conditions: Optional[List[StrictStr]] = None
    revision: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["decision", "matched_policies", "reason", "policy_id", "explain_trace", "failed_conditions", "revision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "explain_trace": obj.get("explain_trace"),
