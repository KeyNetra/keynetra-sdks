...
class AdminLoginResponse(BaseModel):
    ...
    role: Optional[StrictStr] = 'admin'
    tenant_key: StrictStr
    __properties: ClassVar[List[str]] = ["access_token", "token_type", "expires_in", "role", "tenant_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role") if obj.get("role") is not None else 'admin',
