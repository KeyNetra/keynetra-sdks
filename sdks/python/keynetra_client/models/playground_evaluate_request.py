...
class PlaygroundEvaluateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policies", "input"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [PlaygroundPolicy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
            "input": PlaygroundInput.from_dict(obj["input"]) if obj.get("input") is not None else None
        })
        return _obj
