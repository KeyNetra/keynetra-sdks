...
class BatchAccessResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["results", "revision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [BatchAccessResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
