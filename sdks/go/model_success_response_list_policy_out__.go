...
// checks if the SuccessResponseListPolicyOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuccessResponseListPolicyOut{}

// SuccessResponseListPolicyOut struct for SuccessResponseListPolicyOut
...
func NewSuccessResponseListPolicyOut(data []PolicyOut) *SuccessResponseListPolicyOut {
	this := SuccessResponseListPolicyOut{}
	this.Data = data
	return &this
}
...
func (o SuccessResponseListPolicyOut) MarshalJSON() ([]byte, error) {
...
func (o SuccessResponseListPolicyOut) ToMap() (map[string]interface{}, error) {
...
func (o *SuccessResponseListPolicyOut) UnmarshalJSON(data []byte) (err error) {
...
type NullableSuccessResponseListPolicyOut struct {
	value *SuccessResponseListPolicyOut
	isSet bool
}

func (v NullableSuccessResponseListPolicyOut) Get() *SuccessResponseListPolicyOut {
	return v.value
}

func (v *NullableSuccessResponseListPolicyOut) Set(val *SuccessResponseListPolicyOut) {
	v.value = val
	v.isSet = true
}

func (v NullableSuccessResponseListPolicyOut) IsSet() bool {
	return v.isSet
}

func (v *NullableSuccessResponseListPolicyOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuccessResponseListPolicyOut(val *SuccessResponseListPolicyOut) *NullableSuccessResponseListPolicyOut {
	return &NullableSuccessResponseListPolicyOut{value: val, isSet: true}
}

func (v NullableSuccessResponseListPolicyOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuccessResponseListPolicyOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
